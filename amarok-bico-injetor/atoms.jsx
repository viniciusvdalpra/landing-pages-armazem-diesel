// atoms.jsx — small shared components

// Simple stylized nozzle silhouette — no brand likeness, just a generic shape
function NozzleSVG({ color = "rgba(245,245,245,0.85)", size = 180 }) {
  return (
...
Object.assign(window, { NozzleSVG, TrustIcon, WhatsAppIcon, Star });
